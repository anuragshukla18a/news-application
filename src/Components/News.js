...
export class News extends Component {
 ...
 static propType={
  ...
  Updatepage=async(page)=>{
    ...
    let url=`https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.catagory}&apiKey=67ed7db25e634ed496a235229ae49aa1&page=${page}&pageSize=${this.props.pageSize}`;
